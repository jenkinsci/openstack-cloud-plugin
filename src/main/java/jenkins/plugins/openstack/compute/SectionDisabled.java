 ...
 */
public class SectionDisabled extends AbstractDescribableImpl<SectionDisabled> implements Serializable {

    private static final long serialVersionUID = 1L;

    /** Value returned by {@link #toString()} if {@link #isDisabled()} is false. */
    @Restricted(NoExternalUse.class)
    static final String NOT_DISABLED = "No";
    ...
    /**
     * Throws if {@link #isDisabled()} is true.
     * 
     * @param exceptionMsgPrefix String to put in the exception message text before
     *                           the disablement reason. e.g. "Cloud is disabled ".
     * 
     * @throws DisabledException is {@link #isDisabled()} is true.
     */
    @Restricted(NoExternalUse.class)
    public void throwIfDisabled(@Nullable String exceptionMsgPrefix) {
        final String disabledMsg = toString();
        if (NOT_DISABLED.equals(disabledMsg)) {
            return;
        }
        final String msg = Util.fixEmpty(exceptionMsgPrefix) == null ? disabledMsg : exceptionMsgPrefix + disabledMsg;
        throw new DisabledException(msg, exceptionWhenDisabledBySystem);
    }

    /**
     * An {@link IllegalStateException} thrown by
     * {@link SectionDisabled#throwIfDisabled(String)}.
     */
    public static class DisabledException extends IllegalStateException {
        private static final long serialVersionUID = 1L;
    ...
    @Extension
    public static class DescriptorImpl extends Descriptor<SectionDisabled> {
    ...
    public boolean equals(Object o) {
        ...
        final SectionDisabled other = (SectionDisabled) o;
