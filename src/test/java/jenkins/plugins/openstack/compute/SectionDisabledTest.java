...
public class SectionDisabledTest {

    @Test
    public void testHashCodeAndEquals() {
        final SectionDisabled i1 = new SectionDisabled();
        final SectionDisabled i2 = new SectionDisabled();
        i2.setDisabledByChoice(true);
        final SectionDisabled e1 = new SectionDisabled();
        final SectionDisabled e2 = new SectionDisabled();
    ...
    @Test
    public void thowIfDisabledGivenDefaultsThenDoesNotThrow() {
        final TestClass i = new TestClass();

        i.throwIfDisabled(null);
        i.throwIfDisabled("prefix");
    }
    ...
    @Test
    public void thowIfDisabledGivenUserDisabledThenThrows() {
        final TestClass i = new TestClass();
        i.setDisabledByChoice(true);
        ...
        try {
            i.throwIfDisabled(prefix);
        } catch (SectionDisabled.DisabledException ex) {
    ...
    @Test
    public void thowIfDisabledGivenSystemDisabledThenThrows() {
        final TestClass i = new TestClass();
        final long duration = 10000L;
        i.disableBySystem("non", duration, null);
        final String prefix = "something else";
    ...
    private static class TestClass extends SectionDisabled {
