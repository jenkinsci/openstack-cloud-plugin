...
public abstract class AbstractOpenstackCredential extends BaseStandardCredentials
        implements OpenstackCredential, ExtensionPoint {
    private static final long serialVersionUID = -8990261308669288787L;

    public AbstractOpenstackCredential(
