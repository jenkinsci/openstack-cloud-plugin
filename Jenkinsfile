...
// Inlined to intercept with openstack4j dep build
properties([
            ...
            tasks[stageIdentifier] = {
                node(label) {
                    timeout(60) {
                        ...
                        stage("Build openstack4j (${stageIdentifier})") {
                            infra.checkout("git@github.com:ContainX/openstack4j.git")
                            infra.runMaven(["version:set", "-DnewVersion=3.1.1-jenkins1"], jdk)
